...
// hv: [flatH, 0] — flat structure, all slides at vertical index 0
TEACHING_STEPS = [
  ...
  { phase:"KHỞI ĐỘNG", color:"#ff9f1c", title:"Biến trong toán học… và trong lập trình",
    time:2, action:'slide', cqTab:null, cqId:null, slide:1, preset:null, hv:[2,0],
  ...
  { phase:"KHỞI ĐỘNG", color:"#ff9f1c", title:"Biến trong toán học và lập trình là gì?",
    time:2, action:'slide', cqTab:null, cqId:null, slide:1, preset:null, hv:[3,0],
  ...
  { phase:"KHỞI ĐỘNG", color:"#ff9f1c", title:"Câu hỏi thảo luận – Khởi động",
    time:2, action:'slide', cqTab:null, cqId:null, slide:1, preset:null, hv:[4,0],
  ...
  { phase:"KHỞI ĐỘNG", color:"#ff9f1c", title:"Biến xuất hiện khắp nơi trong cuộc sống!",
    time:2, action:'slide', cqTab:null, cqId:null, slide:1, preset:null, hv:[5,0],
  ...
  { phase:"BIẾN & LỆNH GÁN", color:"#2ec4b6", title:"Biến và Lệnh Gán",
    time:1, action:'slide', cqTab:null, cqId:null, slide:2, preset:null, hv:[6,0],
  ...
  { phase:"BIẾN & LỆNH GÁN", color:"#2ec4b6", title:"Biến là gì?",
    time:2, action:'slide', cqTab:null, cqId:null, slide:2, preset:null, hv:[7,0],
  ...
  { phase:"BIẾN & LỆNH GÁN", color:"#2ec4b6", title:"Câu hỏi kiểm tra – Biến là gì?",
    time:2, action:'slide', cqTab:null, cqId:null, slide:2, preset:null, hv:[8,0],
  ...
  { phase:"BIẾN & LỆNH GÁN", color:"#2ec4b6", title:"Lệnh gán đơn",
    time:2, action:'slide', cqTab:null, cqId:null, slide:2, preset:null, hv:[9,0],
  ...
  { phase:"BIẾN & LỆNH GÁN", color:"#2ec4b6", title:"Lệnh gán đồng thời",
    time:2, action:'slide', cqTab:null, cqId:null, slide:2, preset:null, hv:[10,0],
  ...
  { phase:"BIẾN & LỆNH GÁN", color:"#2ec4b6", title:"Câu hỏi – Lệnh gán & Hoán đổi",
    time:2, action:'slide', cqTab:null, cqId:null, slide:2, preset:null, hv:[11,0],
  ...
  { phase:"BIẾN & LỆNH GÁN", color:"#2ec4b6", title:"Quy tắc đặt tên biến",
    time:2, action:'slide', cqTab:null, cqId:null, slide:2, preset:null, hv:[12,0],
  ...
  { phase:"BIẾN & LỆNH GÁN", color:"#2ec4b6", title:"Demo: Biến & Lệnh gán",
    time:2, action:'slide', cqTab:null, cqId:null, slide:2, preset:null, hv:[13,0],
  ...
  { phase:"BIẾN & LỆNH GÁN", color:"#2ec4b6", title:"Kiểu dữ liệu của biến trong Python",
    time:2, action:'slide', cqTab:null, cqId:null, slide:2, preset:null, hv:[14,0],
  ...
  { phase:"BIẾN & LỆNH GÁN", color:"#2ec4b6", title:"Gán nhiều biến = một giá trị · Toán tử kết hợp",
    time:2, action:'slide', cqTab:null, cqId:null, slide:2, preset:null, hv:[15,0],
  ...
  { phase:"BIẾN & LỆNH GÁN", color:"#2ec4b6", title:"Bài tập – Hoạt động 1 (SGK tr.92–93)",
    time:2, action:'slide', cqTab:null, cqId:null, slide:2, preset:null, hv:[16,0],
  ...
  { phase:"PHÉP TOÁN", color:"#e71d36", title:"Phép Toán trên Kiểu Dữ Liệu",
    time:1, action:'slide', cqTab:null, cqId:null, slide:3, preset:null, hv:[17,0],
  ...
  { phase:"PHÉP TOÁN", color:"#e71d36", title:"Phép toán trên kiểu số",
    time:2, action:'slide', cqTab:null, cqId:null, slide:3, preset:null, hv:[18,0],
  ...
  { phase:"PHÉP TOÁN", color:"#e71d36", title:"Phép toán trên xâu ký tự",
    time:2, action:'slide', cqTab:null, cqId:null, slide:3, preset:null, hv:[19,0],
  ...
  { phase:"PHÉP TOÁN", color:"#e71d36", title:"Câu hỏi – Phép toán số & xâu",
    time:2, action:'slide', cqTab:null, cqId:null, slide:3, preset:null, hv:[20,0],
  ...
  { phase:"PHÉP TOÁN", color:"#e71d36", title:"Demo: Phép toán",
    time:2, action:'slide', cqTab:null, cqId:null, slide:3, preset:null, hv:[21,0],
  ...
  { phase:"PHÉP TOÁN", color:"#e71d36", title:"Câu hỏi ôn nhanh đầu Tiết 2",
    time:2, action:'slide', cqTab:null, cqId:null, slide:3, preset:null, hv:[22,0],
  ...
  { phase:"PHÉP TOÁN", color:"#e71d36", title:"Chia nguyên // và Lấy dư %",
    time:2, action:'slide', cqTab:null, cqId:null, slide:3, preset:null, hv:[23,0],
  ...
  { phase:"PHÉP TOÁN", color:"#e71d36", title:"Thứ tự ưu tiên phép toán – Giải từng bước",
    time:2, action:'slide', cqTab:null, cqId:null, slide:3, preset:null, hv:[24,0],
  ...
  { phase:"PHÉP TOÁN", color:"#e71d36", title:"Kiểm tra nhanh – SGK trang 94",
    time:2, action:'slide', cqTab:null, cqId:null, slide:3, preset:null, hv:[25,0],
  ...
  { phase:"TỪ KHÓA", color:"#9b5de5", title:"Từ Khoá (Keywords)",
    time:1, action:'slide', cqTab:null, cqId:null, slide:4, preset:null, hv:[26,0],
  ...
  { phase:"TỪ KHÓA", color:"#9b5de5", title:"Từ khóa (Keywords)",
    time:2, action:'slide', cqTab:null, cqId:null, slide:4, preset:null, hv:[27,0],
  ...
  { phase:"TỪ KHÓA", color:"#9b5de5", title:"Câu hỏi – Từ khóa Python",
    time:2, action:'slide', cqTab:null, cqId:null, slide:4, preset:null, hv:[28,0],
  ...
  { phase:"TỪ KHÓA", color:"#9b5de5", title:"SyntaxError – Lỗi khi dùng từ khóa làm tên biến",
    time:2, action:'slide', cqTab:null, cqId:null, slide:4, preset:null, hv:[29,0],
  ...
  { phase:"TỪ KHÓA", color:"#9b5de5", title:"Bài tập – Hoạt động 3 (SGK tr.95)",
    time:2, action:'slide', cqTab:null, cqId:null, slide:4, preset:null, hv:[30,0],
  ...
  { phase:"THỰC HÀNH", color:"#06d6a0", title:"Thực Hành",
    time:1, action:'slide', cqTab:null, cqId:null, slide:5, preset:null, hv:[31,0],
  ...
  { phase:"THỰC HÀNH", color:"#06d6a0", title:"Bài tập thực hành (SGK tr.95–96)",
    time:2, action:'slide', cqTab:null, cqId:null, slide:5, preset:null, hv:[32,0],
  ...
  { phase:"THỰC HÀNH", color:"#06d6a0", title:"Bài tập 1d · Luyện tập · Phát hiện lỗi",
    time:2, action:'slide', cqTab:null, cqId:null, slide:5, preset:null, hv:[33,0],
  ...
  { phase:"VẬN DỤNG", color:"#f72585", title:"Vận Dụng",
    time:1, action:'slide', cqTab:null, cqId:null, slide:6, preset:null, hv:[34,0],
  ...
  { phase:"VẬN DỤNG", color:"#f72585", title:"Đổi giây ra ngày / giờ / phút / giây",
    time:2, action:'slide', cqTab:null, cqId:null, slide:6, preset:null, hv:[35,0],
  ...
  { phase:"VẬN DỤNG", color:"#f72585", title:"Tại sao Python không cần biến tạm để hoán đổi?",
    time:2, action:'slide', cqTab:null, cqId:null, slide:6, preset:null, hv:[36,0],
  ...
  { phase:"TỔNG KẾT", color:"#4cc9f0", title:"Tổng Kết",
    time:1, action:'slide', cqTab:null, cqId:null, slide:7, preset:null, hv:[37,0],
  ...
  { phase:"TỔNG KẾT", color:"#4cc9f0", title:"Những gì đã học",
    time:2, action:'slide', cqTab:null, cqId:null, slide:7, preset:null, hv:[38,0],
  ...
  { phase:"TỔNG KẾT", color:"#4cc9f0", title:"Câu hỏi củng cố cuối bài",
    time:2, action:'slide', cqTab:null, cqId:null, slide:7, preset:null, hv:[39,0],
  ...
  { phase:"TỔNG KẾT", color:"#4cc9f0", title:"Trò Chơi: Ai Thông Minh Hơn? 🎮",
    time:2, action:'slide', cqTab:null, cqId:null, slide:7, preset:null, hv:[40,0],
